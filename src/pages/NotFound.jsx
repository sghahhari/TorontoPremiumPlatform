  ...
  return (
    <div className="min-h-screen bg-[#F6F4EE] flex items-center justify-center px-6">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-sm p-10 text-center">
        <p className="text-xs font-semibold tracking-widest uppercase text-[#1F4235] mb-3">404</p>
        <h1 className="text-3xl sm:text-4xl font-black text-[#16231D] mb-3" style={{ fontFamily: 'Playfair Display, serif' }}>
          Page not found
        </h1>
