      ...
      <div className="min-h-screen bg-[#F6F4EE] flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-sm p-8">
          ...
          <form onSubmit={onConfirm} className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-[#16231D] mb-1">
                Verification code
              </label>
              <input
                type="text"
                ...
                className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-[#1F4235] focus:outline-none text-center text-2xl tracking-widest"
                placeholder="000000"
                autoFocus
              />
            </div>
    ...
    <div className="min-h-screen bg-[#F6F4EE] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm p-8">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-[#16231D] mb-1">Full name</label>
            <input
              type="text"
              required
              value={form.name}
          ...
          <div>
            <label className="block text-sm font-semibold text-[#16231D] mb-1">Password</label>
            <input
              type="password"
              required
              minLength={8}
        ...
        <div className="mt-6 text-sm text-gray-600">
          ...
          <Link className="font-semibold text-[#1F4235] hover:underline" to="/login">
            Sign in
          </Link>
        </div>
